            ...
            start:
                ...
                begin
                    ...
                    begin
                        ...
                        Sentry.Accuracy * Sentry.Recoil, -Sentry.Damage, Sentry.AmmoType, Sentry.ID, 1);
...
begin
    ...
    begin
        ...
        begin
            ...
            WriteConsole(Sentry.Owner, 'Sentry is broken, go /fix it before zombies destroy it',
                ORANGE);
        ...
        case Sentry.Status of
                                ...
                                if Players[i].Alive then
                                    ...
                                    begin
                                        ...
                                        if sdist < SQR_SENTRY_RANGE then
                                            if RayCast(X, Y - 5, X2, Y2 - 10, False, False, False) then
                                            begin
                                                found := True;
                                                break;
                                            end;
                    ...
                    begin
                        ...
                        begin
                            ...
                            WriteConsole(Sentry.Owner,
                                'Sentry has run out of ammo, load it if you have any (/ammo)', ORANGE);
                        end;
                    end;
                end
                else
                ...
                if Players[Sentry.Owner].Alive then
                    ...
                    begin
                        str := 'State: ' + Sentry_State(Sentry.State) + #13#10 +
                            'Ammo: ' + Sentry_AmmoStatus() + #13#10 + 'HP: ' +
                            IntToStr(100 * Sentry.Hp div SENTRY_HP) + '%';
            ...
            2: begin // under construction
                ...
                begin
                    ...
                    begin
                        BigText_DrawScreenX(DTL_COUNTDOWN, Sentry.Owner,
                            'Construction [' + IntToStr(Sentry.Timer) + ']', 100, DT_CONSTRUCTION, 0.08, 20, 370);
                        Sentry.Timer := Sentry.Timer - 1;
                    end
                    else
                    begin
                        BigText_DrawScreenX(DTL_COUNTDOWN, Sentry.Owner, 'Construction failed.', 100,
                            DT_FAIL, 0.08, 20, 370);
                        Sentry_Clear(False);
                    end;
                end
                ...
                begin
                    ...
                    WriteConsole(0, TaskToName(player[Sentry.Owner].Task, False) +
                        ' ' + Players[Sentry.Owner].Name + ' has placed a sentry gun', GREEN);
            ...
            3: begin // being retrieved
                ...
                begin
                    ...
                    begin
                        BigText_DrawScreenX(DTL_COUNTDOWN, Sentry.Owner,
                            'Deconstruction [' + IntToStr(Sentry.Timer) + ']', 100, DT_CONSTRUCTION, 0.08, 20, 370);
                        Sentry.Timer := Sentry.Timer - 1;
                    end
                    else
                    begin
                        BigText_DrawScreenX(DTL_COUNTDOWN, Sentry.Owner, 'Retrieval failed.',
        ...
        begin
            ...
            begin
                ...
                begin
                        ...
                        begin
                            ...
                            begin
                                ...
                                begin
                                    ...
                                    WriteConsole(ID, 'The sentry gun is being fixed at the moment', RED);
                            end
                            else
                        ...
                        begin
                            ...
                            begin
                                ...
                                begin
                                    ...
                                    WriteConsole(ID, 'You can''t load more ammo, maximal ammo capacity is 5 belts (' +
                                        IntToStr(5 * SENTRY_AMMOINBELT) + ')', RED);
                            end
                            else
                                WriteConsole(ID, 'You don''t have any sentry gun ammo', RED);
                        end;
                    end
                    else
                    ...
                    WriteConsole(ID, 'The sentry is now under constuction/deconstruction', RED);
            end
            else
                    ...
                    begin
                        ...
                        begin
                            ...
                            begin
                                ...
                                WriteConsole(ID, 'You cannot build a sentry gun here, ground is too steep', RED);
                        end
                        else
                        begin
