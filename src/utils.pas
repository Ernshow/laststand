...
function lookForTarget(ID: byte; X, Y, MinDistance, MaxDistance: single;
    UsingRaycast: boolean): byte;

function lookForTarget2(ID: byte; MinDistance, MaxDistance, MaxAngleDiff: single;
    UseRC: boolean; var FoundInRange: boolean): byte;
...
var
    i: shortint;
    A, X, Y, X2, Y2, Vx, Vy, DistSqr: single;
    Team: boolean;
begin
    GetPlayerXY(ID, X, Y);
    Y := Y - 10;
