        ...
        begin
            ...
            begin
                ...
                if dbg_aoi_time then
                    if (TickStatistics[i].EventName = 'AppOnIdle') then
                    begin
                        T := T * 0.99 + 0.01 * ticks;
                        if ticks > T2 then
                        begin
                        ...
                        if Game.TickCount mod 6 = 0 then
                            BigText_DrawScreenX(111, 0, 'AOI: avg: ' + FormatFloat('0.0', T) +
                                #13#10 + '     max: ' + FormatFloat('0.0', T2) + #13#10 +
...
begin
    ...
    begin
        ...
        if (TickStatistics[i].AvgCounter > 0) then
            WriteMessage(ID, 'Average ms: ' + FloatToStr(TickStatistics[i].AvgSum /
                TickStatistics[i].AvgCounter), $FFFFFF);
