...
var
    BW_PlayerInfected, BW_ButcherTauntsMadness, BW_PlagueTauntsRevive,
    BW_PriestTauntsTeleport, BW_TickingTauntsTauntsExplode,
    BW_TickingTauntsExplodeClose, BW_VomitingTauntsVomit, BW_SatanTauntsPenta,
    BW_SatanTauntsHellRain, BW_SatanTauntsExplosion, BW_SatanTauntsLightning,
...
var
    BW_NormalZombies, BW_VomitingZombies, BW_BurningZombies,
    BW_KamikazeZombies, BW_ButcherPartZombies, BW_HaxNormalZombies,
    BW_HaxVomitingZombies, BW_HaxBurningZombies, BW_HaxKamikazeZombies,
    BW_HaxButcherPartZombies: array of tBW_ZombieRecord;
    BW_CustomZombies: array of tBW_ZombieDefinition;
    BW_NormalTauntsKill, BW_NormalTauntsDie, BW_NormalTauntsDmg,
    BW_NormalTauntsSee, BW_NormalTauntsWin, BW_VomitingTauntsKill,
    BW_VomitingTauntsDie, BW_VomitingTauntsDmg, BW_VomitingTauntsSee,
    BW_VomitingTauntsWin, BW_BurningTauntsKill, BW_BurningTauntsDie,
    BW_BurningTauntsDmg, BW_BurningTauntsSee, BW_BurningTauntsWin,
    BW_KamikazeTauntsKill, BW_KamikazeTauntsDie, BW_KamikazeTauntsDmg,
    BW_KamikazeTauntsSee, BW_KamikazeTauntsWin, BW_PartTauntsKill,
    BW_PartTauntsDie, BW_PartTauntsDmg, BW_PartTauntsSee, BW_PartTauntsWin,
    BW_HaxNormalTauntsKill, BW_HaxNormalTauntsDie, BW_HaxNormalTauntsDmg,
    BW_HaxNormalTauntsSee, BW_HaxNormalTauntsWin, BW_HaxVomitingTauntsKill,
    BW_HaxVomitingTauntsDie, BW_HaxVomitingTauntsDmg, BW_HaxVomitingTauntsSee,
    BW_HaxVomitingTauntsWin, BW_HaxBurningTauntsKill, BW_HaxBurningTauntsDie,
    BW_HaxBurningTauntsDmg, BW_HaxBurningTauntsSee, BW_HaxBurningTauntsWin,
    BW_HaxKamikazeTauntsKill, BW_HaxKamikazeTauntsDie, BW_HaxKamikazeTauntsDmg,
    BW_HaxKamikazeTauntsSee, BW_HaxKamikazeTauntsWin, BW_HaxPartTauntsKill,
    BW_HaxPartTauntsDie, BW_HaxPartTauntsDmg, BW_HaxPartTauntsSee,
    BW_HaxPartTauntsWin: array of string;
    BW_Firefighter, BW_Satan, BW_Butcher, BW_Priest, BW_Plague, BW_Trap,
    BW_Flame, BW_Minion, BW_AltarServer, BW_Artifact, BW_KamikazeBoss,
    BW_Scarecrow, BW_Sentry, BW_HaxFirefighter, BW_HaxSatan, BW_HaxButcher,
    BW_HaxPriest, BW_HaxPlague, BW_HaxTrap, BW_HaxFlame, BW_HaxMinion,
    BW_HaxAltarServer, BW_HaxArtifact, BW_HaxKamikazeBoss, BW_HaxScarecrow,
    BW_HaxSentry: tBW_ZombieDefinition;
    BW_CurrentNormalZombieIndex, BW_CurrentVomitingZombieIndex,
    BW_CurrentBurningZombieIndex, BW_CurrentKamikazeZombieIndex: integer;
    BW_NeedShuffleNormalZombies, BW_NeedShuffleVomitingZombies,
    BW_NeedShuffleBurningZombies, BW_NeedShuffleKamikazeZombies: boolean;
...
begin
    Result := random($10, $70) or (random($40, $99) shl 8) or
        (random($10, $70) shl 16);
end;
...
function BW_RanomBotDefinition(Name: string;
    tauntsKill, tauntsDead, tauntsDmg, tauntsSee, tauntsWin: array of string):
tBW_ZombieDefinition;
    //var
...
procedure BW_LoadCustomBot(ini: TIniFile; Name: string;
    var definition: tBW_ZombieDefinition);
begin
{$ifndef FPC}
    ...
    definition.ChatFrequency :=
        byte(ini.ReadInteger(Name, 'ChatFrequency', BW_DEFAULT_CHAT_FREQUENCY));
...
procedure BW_LoadBots(ini: TIniFile; Name: string;
    var recordArr: array of tBW_ZombieRecord);
{$ifndef FPC}
var
    values: TStringList;
    i, j: integer;
...
procedure BW_ConditionalLoadBots(ini: TIniFile; Name: string;
    var Value, backup: array of tBW_ZombieRecord);
begin
  {$ifndef FPC}
...
procedure BW_ConditionalLoadTaunts(ini: TIniFile; Name: string;
    var Value, backup: array of string);
begin
  {$ifndef FPC}
    if ini.SectionExists(Name) then
...
procedure BW_ConditionalLoadCustomBot(ini: TIniFile; Name: string;
    var Value, backup: tBW_ZombieDefinition);
begin
  {$ifndef FPC}
    if ini.SectionExists(Name) then
...
begin
    ...
    try
        ...
        BW_ConditionalLoadBots(BotFile, 'Vomiting', BW_VomitingZombies,
            BW_NormalZombies);
        BW_ConditionalLoadBots(BotFile, 'Kamikaze', BW_KamikazeZombies,
            BW_NormalZombies);

        BW_ConditionalLoadBots(BotFile, 'HaxZombies', BW_HaxNormalZombies,
            BW_NormalZombies);
        BW_ConditionalLoadBots(BotFile, 'HaxBurning', BW_HaxBurningZombies,
            BW_BurningZombies);
        BW_ConditionalLoadBots(BotFile, 'HaxVomiting', BW_HaxVomitingZombies,
            BW_VomitingZombies);
        BW_ConditionalLoadBots(BotFile, 'HaxKamikaze', BW_HaxKamikazeZombies,
            BW_KamikazeZombies);
        BW_ConditionalLoadBots(BotFile, 'HaxParts', BW_HaxButcherPartZombies,
            BW_ButcherPartZombies);
        ...
        BW_ConditionalLoadTaunts(BotFile, 'TauntsKill_Vomiting',
            BW_VomitingTauntsKill, BW_NormalTauntsKill);
        BW_ConditionalLoadTaunts(BotFile, 'TauntsDie_Vomiting',
            BW_VomitingTauntsDie, BW_NormalTauntsDie);
        BW_ConditionalLoadTaunts(BotFile, 'TauntsDmg_Vomiting',
            BW_VomitingTauntsDmg, BW_NormalTauntsDmg);
        BW_ConditionalLoadTaunts(BotFile, 'TauntsWin_Vomiting',
            BW_VomitingTauntsWin, BW_NormalTauntsWin);
        BW_ConditionalLoadTaunts(BotFile, 'TauntsSee_Vomiting',
            BW_VomitingTauntsSee, BW_NormalTauntsSee);

        BW_ConditionalLoadTaunts(BotFile, 'TauntsKill_Burning',
            BW_BurningTauntsKill, BW_NormalTauntsKill);
        BW_ConditionalLoadTaunts(BotFile, 'TauntsDie_Burning',
            BW_BurningTauntsDie, BW_NormalTauntsDie);
        BW_ConditionalLoadTaunts(BotFile, 'TauntsDmg_Burning',
            BW_BurningTauntsDmg, BW_NormalTauntsDmg);
        BW_ConditionalLoadTaunts(BotFile, 'TauntsWin_Burning',
            BW_BurningTauntsWin, BW_NormalTauntsWin);
        BW_ConditionalLoadTaunts(BotFile, 'TauntsSee_Burning',
            BW_BurningTauntsSee, BW_NormalTauntsSee);

        BW_ConditionalLoadTaunts(BotFile, 'TauntsKill_Kamikaze',
            BW_KamikazeTauntsKill, BW_NormalTauntsKill);
        BW_ConditionalLoadTaunts(BotFile, 'TauntsDie_Kamikaze',
            BW_KamikazeTauntsDie, BW_NormalTauntsDie);
        BW_ConditionalLoadTaunts(BotFile, 'TauntsDmg_Kamikaze',
            BW_KamikazeTauntsDmg, BW_NormalTauntsDmg);
        BW_ConditionalLoadTaunts(BotFile, 'TauntsWin_Kamikaze',
            BW_KamikazeTauntsWin, BW_NormalTauntsWin);
        BW_ConditionalLoadTaunts(BotFile, 'TauntsSee_Kamikaze',
            BW_KamikazeTauntsSee, BW_NormalTauntsSee);

        BW_ConditionalLoadTaunts(BotFile, 'TauntsKill_Part',
            BW_PartTauntsKill, BW_NormalTauntsKill);
        BW_ConditionalLoadTaunts(BotFile, 'TauntsDie_Part', BW_PartTauntsDie,
            BW_NormalTauntsDie);
        BW_ConditionalLoadTaunts(BotFile, 'TauntsDmg_Part', BW_PartTauntsDmg,
            BW_NormalTauntsDmg);
        BW_ConditionalLoadTaunts(BotFile, 'TauntsWin_Part', BW_PartTauntsWin,
            BW_NormalTauntsWin);
        BW_ConditionalLoadTaunts(BotFile, 'TauntsSee_Part', BW_PartTauntsSee,
            BW_NormalTauntsSee);

        BW_ConditionalLoadTaunts(BotFile, 'HaxTauntsKill', BW_HaxNormalTauntsKill,
            BW_NormalTauntsKill);
        BW_ConditionalLoadTaunts(BotFile, 'HaxTauntsDie', BW_HaxNormalTauntsDie,
            BW_NormalTauntsDie);
        BW_ConditionalLoadTaunts(BotFile, 'HaxTauntsDmg', BW_HaxNormalTauntsDmg,
            BW_NormalTauntsDmg);
        BW_ConditionalLoadTaunts(BotFile, 'HaxTauntsWin', BW_HaxNormalTauntsWin,
            BW_NormalTauntsWin);
        BW_ConditionalLoadTaunts(BotFile, 'HaxTauntsSee', BW_HaxNormalTauntsSee,
            BW_NormalTauntsSee);

        BW_ConditionalLoadTaunts(BotFile, 'HaxTauntsKill_Vomiting',
            BW_HaxVomitingTauntsKill, BW_VomitingTauntsKill);
        BW_ConditionalLoadTaunts(BotFile, 'HaxTauntsDie_Vomiting',
            BW_HaxVomitingTauntsDie, BW_VomitingTauntsDie);
        BW_ConditionalLoadTaunts(BotFile, 'HaxTauntsDmg_Vomiting',
            BW_HaxVomitingTauntsDmg, BW_VomitingTauntsDmg);
        BW_ConditionalLoadTaunts(BotFile, 'HaxTauntsWin_Vomiting',
            BW_HaxVomitingTauntsWin, BW_VomitingTauntsWin);
        BW_ConditionalLoadTaunts(BotFile, 'HaxTauntsSee_Vomiting',
            BW_HaxVomitingTauntsSee, BW_VomitingTauntsSee);

        BW_ConditionalLoadTaunts(BotFile, 'HaxTauntsKill_Burning',
            BW_HaxBurningTauntsKill, BW_BurningTauntsKill);
        BW_ConditionalLoadTaunts(BotFile, 'HaxTauntsDie_Burning',
            BW_HaxBurningTauntsDie, BW_BurningTauntsDie);
        BW_ConditionalLoadTaunts(BotFile, 'HaxTauntsDmg_Burning',
            BW_HaxBurningTauntsDmg, BW_BurningTauntsDmg);
        BW_ConditionalLoadTaunts(BotFile, 'HaxTauntsWin_Burning',
            BW_HaxBurningTauntsWin, BW_BurningTauntsWin);
        BW_ConditionalLoadTaunts(BotFile, 'HaxTauntsSee_Burning',
            BW_HaxBurningTauntsSee, BW_BurningTauntsSee);

        BW_ConditionalLoadTaunts(BotFile, 'HaxTauntsKill_Kamikaze',
            BW_HaxKamikazeTauntsKill, BW_KamikazeTauntsKill);
        BW_ConditionalLoadTaunts(BotFile, 'HaxTauntsDie_Kamikaze',
            BW_HaxKamikazeTauntsDie, BW_KamikazeTauntsDie);
        BW_ConditionalLoadTaunts(BotFile, 'HaxTauntsDmg_Kamikaze',
            BW_HaxKamikazeTauntsDmg, BW_KamikazeTauntsDmg);
        BW_ConditionalLoadTaunts(BotFile, 'HaxTauntsWin_Kamikaze',
            BW_HaxKamikazeTauntsWin, BW_KamikazeTauntsDmg);
        BW_ConditionalLoadTaunts(BotFile, 'HaxTauntsSee_Kamikaze',
            BW_HaxKamikazeTauntsSee, BW_KamikazeTauntsDmg);

        BW_ConditionalLoadTaunts(BotFile, 'HaxTauntsKill_Part',
            BW_HaxPartTauntsKill, BW_PartTauntsKill);
        BW_ConditionalLoadTaunts(BotFile, 'HaxTauntsDie_Part',
            BW_HaxPartTauntsDie, BW_PartTauntsDie);
        BW_ConditionalLoadTaunts(BotFile, 'HaxTauntsDmg_Part',
            BW_HaxPartTauntsDmg, BW_PartTauntsDmg);
        BW_ConditionalLoadTaunts(BotFile, 'HaxTauntsWin_Part',
            BW_HaxPartTauntsWin, BW_PartTauntsDmg);
        BW_ConditionalLoadTaunts(BotFile, 'HaxTauntsSee_Part',
            BW_HaxPartTauntsSee, BW_PartTauntsDmg);

        tmp := ['Now I will eat you!', 'Roar!', 'Fear me!', 'Grrhhr!', 'Arrggh!'];
        BW_ConditionalLoadTaunts(BotFile, 'TauntsInfection_Player',
            BW_PlayerInfected, tmp);

        tmp := ['Rise again!', 'Rise, zombies!', 'Get up, minions!'];
        BW_ConditionalLoadTaunts(BotFile, 'TauntsRevive_Plague', BW_PlagueTauntsRevive, tmp);

        tmp := ['Roar!'];
        BW_ConditionalLoadTaunts(BotFile, 'TauntsMadness_Butcher',
            BW_ButcherTauntsMadness, tmp);

        tmp := [];
        BW_ConditionalLoadTaunts(BotFile, 'TauntsTeleport_Priest',
            BW_PriestTauntsTeleport, tmp);

        tmp := ['Tick, tick, TICK!'];
        BW_ConditionalLoadTaunts(BotFile, 'TauntsExplode_TickingBomb',
            BW_TickingTauntsTauntsExplode, tmp);

        tmp := ['ALLAHU AKBAR!'];
        BW_ConditionalLoadTaunts(BotFile, 'TauntsExplodeClose_TickingBomb',
            BW_TickingTauntsExplodeClose, tmp);

        tmp := ['Bluhhhr!', 'Mlearhh!', 'Prhhh!', 'Ulhrr!', 'Blurhh!',
            'Brrhhg', 'Arghhr!'];
        BW_ConditionalLoadTaunts(BotFile, 'TauntsVomit_Vomiting',
            BW_VomitingTauntsVomit, tmp);

        tmp := ['You shall burn in hell!', 'Burn!', 'Die!!!'];
        BW_ConditionalLoadTaunts(BotFile, 'TauntsPenta_Satan', BW_SatanTauntsPenta, tmp);

        tmp := ['You shall burn in hell!', 'Burn!', 'Die!!!'];
        BW_ConditionalLoadTaunts(BotFile, 'TauntsExplosion_Satan',
            BW_SatanTauntsExplosion, tmp);

        tmp := ['Hellrain!', 'Come, oh hellrain!'];
        BW_ConditionalLoadTaunts(BotFile, 'TauntsHellRain_Satan',
            BW_SatanTauntsHellRain, tmp);

        tmp := [];
        BW_ConditionalLoadTaunts(BotFile, 'TauntsLightning_Satan',
            BW_SatanTauntsLightning, tmp);

        tmp := [];
        BW_ConditionalLoadTaunts(BotFile, 'TauntsMinions_Satan',
            BW_SatanTauntsMinions, tmp);

        tmp := ['This arrow shall bring death!'];
        BW_ConditionalLoadTaunts(BotFile, 'TauntsArrow_Satan', BW_SatanTauntsArrow, tmp);

        tmp := [];
        BW_ConditionalLoadTaunts(BotFile, 'TauntsPortal_Firefighter',
            BW_FirefighterTauntsPortal, tmp);

        tmp := [];
        BW_ConditionalLoadTaunts(BotFile, 'TauntsTrap_Firefighter',
            BW_FirefighterTauntsTrap, tmp);

        tmp := ['I am the god of hellfire, and i bring you FIRE!  '];
        BW_ConditionalLoadTaunts(BotFile, 'TauntsTrap_Firefighter',
            BW_FirefighterTauntsHeat, tmp);
        ...
        BW_ConditionalLoadCustomBot(BotFile, 'HaxFirefighter',
            BW_HaxFirefighter, BW_Firefighter);
        ...
        BW_ConditionalLoadCustomBot(BotFile, 'HaxAltarServer',
            BW_HaxAltarServer, BW_AltarServer);
        BW_ConditionalLoadCustomBot(BotFile, 'HaxArtifact', BW_HaxArtifact, BW_Artifact);
        BW_ConditionalLoadCustomBot(BotFile, 'HaxKamikazeBoss',
            BW_HaxKamikazeBoss, BW_KamikazeBoss);
        BW_ConditionalLoadCustomBot(BotFile, 'HaxScarecrow', BW_HaxScarecrow,
            BW_Scarecrow);
...
begin
    ...
    begin
        if hax then
            definition := BW_RanomBotDefinition(zombieRecord.Name,
                BW_HaxNormalTauntsKill, BW_HaxNormalTauntsDie, BW_HaxNormalTauntsDmg,
                BW_HaxNormalTauntsSee, BW_HaxNormalTauntsWin)
        else
            definition := BW_RanomBotDefinition(zombieRecord.Name,
                BW_NormalTauntsKill, BW_NormalTauntsDie, BW_NormalTauntsDmg,
                BW_NormalTauntsSee, BW_NormalTauntsWin);
    end
    else
...
begin
    ...
    begin
        if hax then
            definition := BW_RanomBotDefinition(zombieRecord.Name,
                BW_HaxVomitingTauntsKill, BW_HaxVomitingTauntsDie, BW_HaxVomitingTauntsDmg,
                BW_HaxVomitingTauntsSee, BW_HaxVomitingTauntsWin)
        else
            definition := BW_RanomBotDefinition(zombieRecord.Name,
                BW_VomitingTauntsKill, BW_VomitingTauntsDie, BW_VomitingTauntsDmg,
                BW_VomitingTauntsSee, BW_VomitingTauntsWin);
    end
    else
        definition := BW_CustomZombies[zombieRecord.CustomDefinitionIndex];
...
begin
    ...
    begin
        if hax then
            definition := BW_RanomBotDefinition(zombieRecord.Name,
                BW_HaxBurningTauntsKill, BW_HaxBurningTauntsDie, BW_HaxBurningTauntsDmg,
                BW_HaxBurningTauntsSee, BW_HaxBurningTauntsWin)
        else
            definition := BW_RanomBotDefinition(zombieRecord.Name,
                BW_BurningTauntsKill, BW_BurningTauntsDie, BW_BurningTauntsDmg,
                BW_BurningTauntsSee, BW_BurningTauntsWin);
    end
    else
        definition := BW_CustomZombies[zombieRecord.CustomDefinitionIndex];
...
begin
    ...
    begin
        if hax then
            definition := BW_RanomBotDefinition(zombieRecord.Name,
                BW_HaxKamikazeTauntsKill, BW_HaxKamikazeTauntsDie, BW_HaxKamikazeTauntsDmg,
                BW_HaxKamikazeTauntsSee, BW_HaxKamikazeTauntsWin)
        else
            definition := BW_RanomBotDefinition(zombieRecord.Name,
                BW_KamikazeTauntsKill, BW_KamikazeTauntsDie, BW_KamikazeTauntsDmg,
                BW_KamikazeTauntsSee, BW_KamikazeTauntsWin);
    end
    else
        definition := BW_CustomZombies[zombieRecord.CustomDefinitionIndex];
...
begin
    ...
    begin
        if hax then
            definition := BW_RanomBotDefinition(zombieRecord.Name,
                BW_HaxPartTauntsKill, BW_HaxPartTauntsDie, BW_HaxPartTauntsDmg,
                BW_HaxPartTauntsSee, BW_HaxPartTauntsWin)
        else
            definition := BW_RanomBotDefinition(zombieRecord.Name,
                BW_PartTauntsKill, BW_PartTauntsDie, BW_PartTauntsDmg, BW_PartTauntsSee,
                BW_PartTauntsWin);
    end
    else
        definition := BW_CustomZombies[zombieRecord.CustomDefinitionIndex];
