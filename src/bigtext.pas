...
procedure BigText_DrawMap(ID: byte; Text: string; Duration: integer;
    Colour: longint; Scale: single; X, Y: integer);
procedure BigText_DrawMapX(Layer: byte; ID: byte; Text: string;
    Duration: integer; Colour: longint; Scale: single; X, Y: integer);
procedure BigText_DrawScreen(ID: byte; Text: string; Duration: integer;
    Colour: longint; Scale: single; X, Y: integer);
procedure BigText_DrawScreenX(Layer: byte; ID: byte; Text: string;
    Duration: integer; Colour: longint; Scale: single; X, Y: integer);
...
procedure BigText_DrawS(ID: byte; var Text: string; Duration: integer;
    Colour: longint; Scale: single; X, Y: integer);
var
    i: byte;
begin
    for i := ST_First to BIGTEXT_ST_NUM do
    begin
        if TextPlayer[ID].ScreenText[i].EndTime <= Game.TickCount then
        begin
...
procedure BigText_DrawM(ID: byte; var Text: string; Duration: integer;
    Colour: longint; Scale: single; X, Y: integer);
var
    i: byte;
begin
    for i := MT_First to BIGTEXT_MT_NUM do
    begin
        if TextPlayer[ID].MapText[i].EndTime <= Game.TickCount then
        begin
