...
type
    TDamageType = (General, Explosion, Heat, Wires, Shotgun, SentryGun,
        Helicopter, HolyWater, ExoMagic);
...
procedure Damage_ZombiesAreaDamage(ID: byte; x, y, r1, r2, damage: single;
    DamageType: TDamageType);

// Damage will be given taking player-specific resitances and damage multipliers into account.
procedure Damage_DoRelative(Victim, Shooter: byte; Damage: integer;
    DamageType: TDamageType);
        ...
        if Players[i].Alive then
            ...
            begin
                ...
                begin
                    ...
                    if dist < r1 then
                    begin // damage in radius 1 remains unchanged
                    end
                    else
                    begin
